...
namespace SalesEngCustomOrbitActivities {
    ...
    public partial class EGUG2014Workflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(EGUG2014Workflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(EGUG2014Workflow));
        ...
        private string FindResource() {
            string[] resources = typeof(EGUG2014Workflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".EGUG2014Workflow.g.xaml") || resource.Equals("EGUG2014Workflow.g.xaml"))) {
                    return resource;
                }
            }
